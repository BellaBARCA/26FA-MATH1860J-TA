...
Friendly Reminders:
    \begin{itemize}
        \item Lectures given by Prof. Hohberger will be online, while those given by Prof. Zwaan will be in-person. The content of two sections will be consistent and coherent.
...
\begin{columns}[c]
    \begin{column}{0.4\textwidth}
        \centering
        You could join the unofficial Q \& A group chat if you have any questions or concerns about the course. \\
        \vspace{0.5em}
        If you fail to join the group chat by QR code, please contact us via email, Feishu or WeChat. \\
    \end{column}
    \begin{column}{0.6\textwidth}
        \centering
